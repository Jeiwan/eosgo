...
func TestGetFullBlock(t *testing.T) {
	...
	assert.Equal(t, "ef919ff6ed63578c7632e7029ac4eb6ec1fceeaf7f5629e9b36bded9ed4f3c49", resp.TransactionMroot)
	assert.Equal(t, "d91ddc84af3b36dc80375ca988c4c5421e16aa0622f11343669ffdb2be800027", resp.ActionMroot)
	assert.Equal(t, 0, resp.ScheduleVersion)
	// assert.Equal(t, nil, resp.NewProducers)
	// assert.Equal(t, nil, resp.HeadExtensions)
	...
	trx := txH.Trx
	assert.Equal(t, "1bc395276f4bdde15a7992e50e61938457673e861d9480b51762b6e4457e5b79", trx.ID)
	...
	assert.Equal(t, "", trx.PackedContextFreeData)
	...
	assert.Equal(t, "deadbeef0", a.HexData)
	...
	assert.Equal(t, "0000000000ea3055a09862fd499b896900200000", a.HexData)
	...
	assert.Equal(t, "deadbeef1", a.HexData)
	...
	assert.Equal(t, "deadbeef2", a.HexData)

	// assert.Equal(t, nil, resp.BlockExtensions)
	assert.Equal(t, "000003e8ddc03486114e6a1c764f0f78dab559ed18519802b4399a8d89e48264", resp.ID)
